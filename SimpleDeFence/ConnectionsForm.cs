...
namespace SimpleDeFence
{
    internal partial class ConnectionsForm : Form
    {
        ...
        private void mnuCloseProcess_Click(object sender, EventArgs e)
        {
            foreach (ListViewItem li in list.SelectedItems)
            {
                ...
                try
                {
                    ...
                    {
                        MessageBox.Show(this, string.Format(CultureInfo.CurrentCulture, Resources.Messages.CouldNotCloseProcess, proc.ProcessName, pi.Pid), Resources.Messages.SimpleDeFence, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    }
                }
                catch
                {
        ...
        private void mnuVirusTotal_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this, Resources.Messages.CannotGetPathOfProcess, Resources.Messages.SimpleDeFence, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
