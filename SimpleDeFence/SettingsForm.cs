    ...
    internal partial class SettingsForm : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (chkChangePassword.Checked)
            {
                ...
                {
                    MessageBox.Show(this, Resources.Messages.PasswordFieldsDoNotMatch, Resources.Messages.SimpleDeFence, MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
                }
            }
        ...
        {
            if (MessageBox.Show(this, Resources.Messages.AreYouSureYouWantToRemoveAllExceptions, Resources.Messages.SimpleDeFence, MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation) == System.Windows.Forms.DialogResult.No)
                return;
        ...
        private void btnImport_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog(this) == DialogResult.OK)
            {
                ...
                {
                    // Fail import.
                    MessageBox.Show(this, Resources.Messages.ConfigurationImportError, Resources.Messages.SimpleDeFence, MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }

                InitSettingsUI();
                MessageBox.Show(this, Resources.Messages.ConfigurationHasBeenImported, Resources.Messages.SimpleDeFence, MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
